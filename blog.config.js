...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://lzk.pp.ua', // 网站地址
  ...
  _HOST: process.env.NEXT_PUBLIC__HOST || 'https://www..so', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'liash小站', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || 'liash小站', // 站点描述，被notion中的页面描述覆盖
